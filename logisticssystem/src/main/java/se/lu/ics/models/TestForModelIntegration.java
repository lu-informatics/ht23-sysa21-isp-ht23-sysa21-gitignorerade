...
import lu.ics.se.models.ServiceAction;
import lu.ics.se.models.ServiceEvent;
import lu.ics.se.models.ServiceRecord;
...
public class TestForModelIntegration {
        ...
        public static void main(String[] args) {
            ...
            try {
                serviceRecord.addServiceEvent(maintenanceEvent1);
                serviceRecord.addServiceEvent(maintenanceEvent2);
            } catch (ServiceRecord.LargeTruckInternalServiceException e) {
                e.printStackTrace();
            }
    
            // Set service history for vehicles
            largeTruck.setServiceHistory(serviceRecord);
            mediumTruck.setServiceHistory(serviceRecord);
            van.setServiceHistory(serviceRecord);
